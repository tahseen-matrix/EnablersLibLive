...
object RenderPopup : ApiInterfaceModel.OnApiResponseListener {
    ...
    fun checkFirstRun(context: AppCompatActivity, layout: Int, viewGroup: ViewGroup) {
        ...
        builder.setPositiveButton("Yes") { _, _ ->
            ...
            Handler(Looper.myLooper()!!).postDelayed({
                ...
                getPops(context, context.packageName, viewGroup)
            }, 500)
    ...
    fun showPopups(context: AppCompatActivity, layout: Int, viewGroup: ViewGroup) {
        ...
        if (context.getSharedPreferences("renderFirstPop", MODE_PRIVATE)
            ...
            checkFirstRun(context, layout, viewGroup)
        }
        if (context.getSharedPreferences("renderFirstPop", MODE_PRIVATE)
    ...
    private fun getPops(context: AppCompatActivity, applicationId: String, viewGroup: ViewGroup) {
        ...
        service.getJson(applicationId).enqueue(object : Callback<JsonObject> {
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                if (response.isSuccessful) {
                    ...
                    ApiInterfaceModel.instance!!.apiCall(json, viewGroup)
    ...
    private fun createPopUpView(context: AppCompatActivity, mViewGroup: ViewGroup): View {
        return LayoutInflater.from(context).inflate(R.layout.popup_layout, mViewGroup, false)
    }
    ...
    override fun onResponsePopup(jsonObjectModel: JsonObject?, viewGroup: ViewGroup) {
